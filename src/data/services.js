...
export const services = [
  ...
  },
  {
    slug: 'barbershops',
    name: 'Barbershops',
    tagline: 'Fill every chair, cut the no-shows',
    heroHeadline: 'Your Chairs Should Be Full — Not Your Voicemail',
    heroSubtext: 'Clients want to book a cut right now — by phone or online. When they can\'t get through, they walk into the shop down the block. Your AI answers every call, books every appointment, and keeps your chairs earning all day.',
    painPoints: [
      {
        icon: 'Scissors',
        title: 'You Can\'t Answer the Phone Mid-Haircut',
        description: 'You\'re halfway through a fade and your phone rings. You can\'t stop, the client can\'t wait, and the caller hangs up after three rings. That\'s a $30–$60 appointment gone — and they\'re already calling the next shop.',
      },
      {
        icon: 'Moon',
        title: 'After-Hours Booking Requests Go Nowhere',
        description: 'Clients decide they need a cut at 10pm while scrolling their phone. They call, hit voicemail, and book somewhere else by morning. AI captures those bookings the moment they\'re ready to commit.',
      },
      {
        icon: 'CalendarX',
        title: 'No-Shows Leave Empty Chairs and Lost Revenue',
        description: 'A no-show at a busy barbershop costs you the slot and the walk-in you turned away. Automated SMS reminders with one-tap confirm dramatically reduce no-shows and keep every chair producing.',
      },
      {
        icon: 'PhoneOff',
        title: 'Walk-In Culture Means Phone Calls Get Ignored',
        description: 'When the shop is packed with walk-ins, nobody\'s answering the phone. But phone callers are often your most loyal repeat clients booking ahead. Ignoring them pushes them to competitors with online booking.',
      },
      {
        icon: 'RefreshCw',
        title: 'No System to Bring Clients Back on Schedule',
        description: 'A client who comes every 3 weeks hasn\'t shown up in 5. Without a reminder, they drift to another barber. AI sends a rebooking nudge at exactly the right interval to keep your regulars regular.',
      },
      {
        icon: 'DollarSign',
        title: 'Hiring a Receptionist Doesn\'t Make Financial Sense',
        description: 'Most barbershops can\'t justify a $2,500/month receptionist just to answer the phone and book appointments. AI does it 24/7 for a fraction of the cost — and never calls in sick.',
      },
    ],
    solutions: [
      {
        title: 'Every Call Answered — Even Mid-Fade',
        description: 'AI answers as your barbershop instantly, collects the client\'s name, preferred barber, service type (cut, beard, lineup, combo), and books directly into your calendar — all while you keep cutting.',
      },
      {
        title: '24/7 Appointment Booking by Phone',
        description: 'Clients call any time — evenings, weekends, holidays — and get booked into real-time available slots. No app downloads, no website navigation. Just call and book.',
      },
      {
        title: 'No-Show Killer Reminders',
        description: 'Automated SMS reminders 24h and 2h before every appointment with one-tap confirm or reschedule. Cancelled slots are instantly released for walk-ins or waitlist clients.',
      },
      {
        title: 'Rebooking Sequences That Keep Chairs Full',
        description: 'AI tracks each client\'s visit frequency and sends a rebooking reminder when they\'re due. Clients who haven\'t returned in 4+ weeks get a personalized nudge to come back.',
      },
      {
        title: 'Fraction of the Cost of a Receptionist',
        description: 'Full 24/7 call answering, booking, reminders, and rebooking — for less than what you\'d pay a part-timer for 20 hours a week. The math works from day one.',
      },
      {
        title: 'Walk-In Waitlist Management',
        description: 'When all chairs are full, AI tells callers the current wait time and offers to add them to the waitlist with an SMS alert when their turn is near — so they don\'t wait in the shop or leave frustrated.',
      },
    ],
    callFlow: [
      { step: 1, text: 'Client calls to book — AI answers instantly as your barbershop' },
      { step: 2, text: 'AI collects: name, preferred barber, service type, and preferred time' },
      { step: 3, text: 'Appointment booked into your live calendar — SMS confirmation sent to client' },
      { step: 4, text: 'Reminder sequence (24h + 2h) fires automatically to prevent no-shows' },
      { step: 5, text: 'Rebooking nudge sent when client is due for their next visit' },
    ],
  },
  {
    slug: 'plumbing',
  ...
  },
  {
    ...
    tagline: 'AI call handling for any local business',
    heroHeadline: 'Your Business Deserves an AI That Never Misses a Call',
    heroSubtext: 'Whether you run a pet grooming shop, a law office, a gym, or any other local business — missed calls mean missed revenue. Your AI answers every call, books appointments, and follows up automatically so you can focus on what you do best.',
    painPoints: [
      {
        icon: 'PhoneOff',
        title: 'Missed Calls Are Missed Revenue',
        description: 'Every time your phone goes to voicemail, a potential customer calls the next business on the list. Whether it\'s a $50 service or a $5,000 contract, the first business to answer wins the job.',
      },
      {
        icon: 'Clock',
        title: 'You\'re Too Busy Working to Answer the Phone',
        description: 'You\'re with a client, managing your team, or handling operations — and the phone keeps ringing. You can\'t do both. AI handles every inbound call so you stay focused on delivering your service.',
      },
      {
        icon: 'Moon',
        title: 'After-Hours Calls Disappear',
        description: 'Customers don\'t only need you 9-to-5. Evening and weekend callers are often the most motivated buyers. AI captures them when they\'re ready to commit — not the next morning when they\'ve moved on.',
      },
    ],
    solutions: [
      {
        title: 'Always-On Call Answering',
        description: 'AI answers every call as your business — 24/7, 365 days a year. It collects the caller\'s name, need, and contact info, then books appointments or sends you a complete lead summary instantly.',
      },
      {
        title: 'Appointment Booking on Autopilot',
        description: 'AI checks your real-time calendar and books clients into available slots. Confirmation and reminders sent automatically. No double-bookings, no missed appointments.',
      },
      {
        title: 'Follow-Up That Never Forgets',
        description: 'Every inquiry that doesn\'t convert on the first call enters an automated follow-up sequence. Leads are nurtured until they\'re ready to buy — no manual effort required.',
      },
    ],
    callFlow: [
      { step: 1, text: 'Customer calls your business — AI answers instantly with your business name' },
      { step: 2, text: 'AI identifies the caller\'s need: appointment, question, quote, or urgent request' },
      { step: 3, text: 'Appointment booked in your calendar or lead details captured' },
      { step: 4, text: 'Confirmation + reminder sequence sent to the customer' },
